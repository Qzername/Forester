...
namespace ForesterAPI.Data
{
    public class FileDatabase
    {
        ...
        public void UpdatePicture(ObjectType objectType, string name, PictureType pictureType, IFormFile picture) => pictureManager.Update(objectType, name, pictureType, picture);
